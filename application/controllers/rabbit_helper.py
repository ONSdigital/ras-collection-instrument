...
initialise_rabbitmq_queue = functools.partial(
    _initialise_rabbitmq, publisher_type=QueuePublisher, rabbitmq_amqp_config="RABBITMQ_AMQP_SURVEY_RESPONSE"
)
send_message_to_rabbitmq_queue = functools.partial(
    _send_message_to_rabbitmq, publisher_type=QueuePublisher, rabbitmq_amqp_config="RABBITMQ_AMQP_SURVEY_RESPONSE"
)
