import unittest
from swagger_server.controllers_local.survey_response import SurveyResponse, INCOMPLETE_UPLOAD, UPLOAD_SUCCESSFUL, \
    FILE_NAME_LENGTH_ERROR, FILE_TYPE_ERROR, SURVEY_RESPONSE_NOT_FOUND
from werkzeug.datastructures import FileStorage


TEST_FILE_LOCATION = 'swagger_server/test_local/test.xlsx'
