...
class Collectioninstrument(Model):
    ...
    """
    def __init__(self, id: str='urn:ons.gov.uk:id:ci:001.234.56789', ci_type: str='OFFLINE', classifiers: Classifiers=None, survey_id: str='urn:ons.gov.uk:id:survey:001.234.56789'):
        """
