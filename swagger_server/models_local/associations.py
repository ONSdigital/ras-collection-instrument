...
instrument_exercise_table = Table('instrument_exercise', ons_env.db.base.metadata,
    Column('instrument_id', Integer, ForeignKey(prefix+'instrument.id')),
    Column('exercise_id', Integer, ForeignKey(prefix+'exercise.id')),
    schema=schema
)

instrument_business_table = Table('instrument_business', ons_env.db.base.metadata,
    Column('instrument_id', Integer, ForeignKey(prefix+'instrument.id')),
